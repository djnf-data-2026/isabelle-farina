...
MediaBucks %>%
  ...
  group_by(Average_Salary = mean(Salary, na.rm=TRUE))
...
```{r}
#1: Build a table for NewYorkTimes employees   
York <- subset(MediaBucks, grepl("?NewYorkTimes", COMPANY)) 
...
Try [Basic Data Visualization in
R](https://wellsdata.github.io/DJNF_Merrill/Intro_to_R_2024/DJNF_Basic_Data_Viz.html)
